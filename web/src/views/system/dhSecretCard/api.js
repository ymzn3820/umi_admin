...
export const urlPrefix = '/api/system/dh_secret/'
export const urlPrefixAssign = '/api/system/assign_customer/'
...
export function AssignCustomer (obj) {
  return request({
    url: urlPrefixAssign,
    data: obj,
    method: 'post'
...
export function GetDeptEmployee (obj) {
  return request({
    url: urlPrefixAssign,
    data: obj,
    method: 'get'
