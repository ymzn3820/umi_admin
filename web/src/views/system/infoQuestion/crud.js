    ...
    columns: [
      {
        ...
        type: 'select',
        dict: {
          url: '/api/system/question_set_dict/',
          label: 'content',
          value: 'question_id',
          cache: false
        },
      ...
      },
      {
        ...
        dict: {
          ...
          url: (dict, { form, component }) => {
            if (form.info_type_id) {
              return '/api/system/info_option_dict/' + '?info_type_id=' + form.info_type_id
            } else {
              return '/api/system/info_option_dict/'
            }
          }
        },
        search: {
      ...
      },
      {
        ...
        form: {
          ...
          helper: {
            render (h) {
              return (< el-alert title="同一个问题权重值越大，显示越靠前" type="warning" />
              )
            }
          }
        }
