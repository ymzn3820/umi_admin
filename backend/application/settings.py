...
DATABASES = {
    "default": {
        ...
        "NAME": DATABASE_NAME_GRAY if GRAY else DATABASE_NAME,
        "USER": DATABASE_USER,
    ...
    "server": {
        ...
        "NAME": SERVER_DATABASE_NAME_GRAY if GRAY else SERVER_DATABASE_NAME ,
...
if not locals().get('REDIS_HOST', ""):
    ...
    CHANNEL_LAYERS = {
        ...
        'secret_key': {
            'BACKEND': 'channels_redis.core.RedisChannelLayer',
            'CONFIG': {
                "hosts": [(REDIS_URL_SECRET_KEY)],  # 需修改
            },
        },
        "customer_balance": {
            "BACKEND": "django_redis.cache.RedisCache",
            "LOCATION": REDIS_URL_SECRET_KEY_CUSTOMER_BALANCE,  # 你的Redis服务器的URL
            "OPTIONS": {
        ...
        'sd_models': {
            'BACKEND': 'channels_redis.core.RedisChannelLayer',
            "LOCATION": REDIS_URL_SD_MODEL_LIST,  # 你的Redis服务器的URL
            "OPTIONS": {
                "CLIENT_CLASS": "django_redis.client.DefaultClient",
            }
        },
...
CACHES = {
    "default": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": REDIS_URL,  # 你的Redis服务器的URL
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    "secret_key": {
        "BACKEND": "django_redis.cache.RedisCache",
        "LOCATION": REDIS_URL_SECRET_KEY,  # 你的Redis服务器的URL
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    },
    ...
    'hashrates_rules': {
        'BACKEND': 'django_redis.cache.RedisCache',
        "LOCATION": REDIS_URL_HASHRATE_RULES,  # 你的Redis服务器的URL
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
        }
    }
